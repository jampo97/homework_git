...
def test_account_or_card_err_acc() -> None:
...
def test_account_or_card_err_numbers() -> None:
...
def test_mask_account_card(user_text_card: str) -> None:
...
def test_mask_account_acc(user_text_acc: str) -> None:
